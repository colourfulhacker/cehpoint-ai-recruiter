...
import { ArrowRight, Mic, Briefcase, User, Megaphone, Terminal, Cpu, CheckCircle2, Globe } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              {Object.values(JobRole).map((r) => (
                <button
                  ...
                  type="button"
                  onClick={() => setRole(r)}
                  className={`relative flex flex-col items-center justify-center p-4 rounded-xl border transition-all duration-200 group h-32 text-center gap-3 ${
                    role === r
